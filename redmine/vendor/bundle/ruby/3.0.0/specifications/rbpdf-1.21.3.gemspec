...
Gem::Specification.new do |s|
  ...
  s.rdoc_options = ["--exclude".freeze, "lib/core/mini_magick.rb".freeze, "--exclude".freeze, "lib/htmlcolors.rb".freeze, "--exclude".freeze, "lib/unicode_data.rb".freeze]
